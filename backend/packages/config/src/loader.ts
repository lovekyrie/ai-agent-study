...
function loadEnvFiles(): void {
  // 这里调用 findMonorepoRoot 是走的 package.json 里的 exports 路径 然后调试的时候执行的vitest 它会处理把.ts file 编译成.js file
  // 所以在@ai-agent-study/workspace/src/index.ts 中能 export findMonorepoRoot.js 文件
